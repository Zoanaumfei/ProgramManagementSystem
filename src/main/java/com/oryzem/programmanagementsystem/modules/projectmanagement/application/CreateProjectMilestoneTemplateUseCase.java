...
@Service
public class CreateProjectMilestoneTemplateUseCase {
    ...
    public CreateProjectMilestoneTemplateUseCase(
    ...
    public TemplateViews.ProjectTemplateMilestoneTemplateView execute(String templateId, CreateProjectMilestoneTemplateCommand command, AuthenticatedUser actor) {
        ...
        ProjectMilestoneTemplateAggregate entity = milestoneTemplateRepository.save(new ProjectMilestoneTemplateAggregate(
                ProjectIds.newProjectMilestoneTemplateId(),
                templateId,
    ...
    public record CreateProjectMilestoneTemplateCommand(
