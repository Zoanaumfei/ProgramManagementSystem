...
public class ListProjectMilestonesUseCase {
    ...
    public ListProjectMilestonesUseCase(
    ...
    public List<ProjectReadModels.ProjectMilestoneListReadModel> execute(String projectId, String structureNodeId, AuthenticatedUser actor) {
        ...
        return milestones.stream()
                ...
                .map(viewMapper::toProjectMilestoneListReadModel)
                .toList();
    }
}
