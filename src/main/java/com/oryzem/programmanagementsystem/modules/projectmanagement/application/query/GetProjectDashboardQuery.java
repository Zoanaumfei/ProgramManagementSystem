...
public class GetProjectDashboardQuery {
    ...
    public GetProjectDashboardQuery(
    ...
    public DashboardViews.ProjectDashboardView execute(String projectId, String structureNodeId, AuthenticatedUser actor) {
        ...
        return new DashboardViews.ProjectDashboardView(
                projectId,
