...
@Service
public class UpdateDeliverableTemplateUseCase {
    ...
    public UpdateDeliverableTemplateUseCase(
    ...
    public TemplateViews.ProjectTemplateDeliverableTemplateView execute(String templateId, String deliverableTemplateId, UpdateDeliverableTemplateCommand command, AuthenticatedUser actor) {
        ...
        if (existing.stream().anyMatch(item -> !item.id().equals(deliverableTemplateId) && item.code().equalsIgnoreCase(command.code().trim()))) {
        ...
        entity = entity.update(
                ...
                command.priority());
        entity = deliverableTemplateRepository.save(entity);
    ...
    public record UpdateDeliverableTemplateCommand(
